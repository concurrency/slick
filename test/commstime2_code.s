...
/*
 *	test stuff for x86-64 scheduler -- commstime (with direct 64-bit I/O)
 */
...
.L1:
	movq	%rbp, %rdi
	movq	32(%rbp), %rsi
	movq	8(%rbp), %rdx			/* load actual value */
	call	os_chanoutv64
...
.L2:
	...
	movq	%rax, %rdx			/* int64 v (value from rax) */
	call	os_chanoutv64
